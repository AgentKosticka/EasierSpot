...
object BleConstants {
    ...
    val CHAR_DEVICE_ID: UUID = UUID.fromString("12345678-1234-5678-1234-567812340001")

    // Hotspot Data - NOTIFY
    // Server notifies with SSID + password credentials
    // Format: [1 byte SSID length][SSID][1 byte password length][password]
    val CHAR_HOTSPOT_DATA: UUID = UUID.fromString("12345678-1234-5678-1234-567812340002")

    // Approval Status - INDICATE
    // Server indicates approval status: 0x00 = denied, 0x01 = approved
    val CHAR_APPROVAL_STATUS: UUID = UUID.fromString("12345678-1234-5678-1234-567812340003")

    // Client ID - WRITE
    // Client writes its stable app/device identifier so server can remember approvals reliably
    val CHAR_CLIENT_ID: UUID = UUID.fromString("12345678-1234-5678-1234-567812340004")
